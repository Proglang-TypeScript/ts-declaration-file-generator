...
import { FunctionDeclaration, ArgumentDeclaration } from '../src/TypescriptDeclaration/FunctionDeclaration';
...
describe('FunctionDeclarationCleaner', () => {
	describe('UnionTypes', () => {
		it('should unify argument types when the return type is the same', () => {
			...
			expectedFunction.addArgument(new ArgumentDeclaration(0, "a")
				.addTypeOf("string")
				.addTypeOf("number")
			);
